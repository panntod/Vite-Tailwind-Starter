    ...
    <main className="h-screen w-screen flex flex-col-reverse sm:flex-row justify-center items-center bg-gray-900 gap-12 px-4 sm:px-0">
      <section className="w-full sm:w-1/2">
        <h1 className="font-bold text-4xl sm:text-6xl text-white mb-4">
          <span className="bg-gradient-to-br text-transparent bg-clip-text from-blue-500 via-purple-500 to-pink-400">Vite</span>
          +
        ...
        <p className="font-semibold text-xl sm:text-4xl text-gray-400 mb-8">Get ready for a development environment <br /> that can finally catch up with you.</p>
        <a href="https://panntod.github.io/Project-Mandiri/linktree" className="px-6 py-3 bg-gray-900 border border-blue-600 text-blue-500 rounded-full hover:bg-blue-700 hover:text-slate-200 transition duration-300 ease-in-out transform hover:scale-105">See Developer Profile</a>
      </section>
